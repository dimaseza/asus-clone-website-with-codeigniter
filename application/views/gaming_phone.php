...
<head>
      ...
      <title>Gaming Phone | Phone | ASUS Indonesia</title>
      <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" rel="stylesheet" />
      <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
      <link rel="stylesheet" href="./assets/css/gaming_phone.css">
</head>
...
<body>
                                          ...
                                          <li class="dropdown-submenu"><a class="dropdown-item" href="#">Phone</a>
                                                <ul class="dropdown-menu">
                                                      <li><a class="dropdown-item" href="#">Phone</a>
                                                            <ul>
                                                                  <li><a class="phoneMenu" href="<?php echo site_url('gaming_phone') ?>">Gaming
                                                                              Phone</a>
                                                                  </li>
      ...
      <!-- Title -->
      <section class="headerTitle mt-4">
            <div class="container">
                  <div class="row">
                        <div class="col">
                              <h4>Phone (2)</h4>
            ...
            <div class="container">
                  <div class="row">
                        <div class="col-3">
                              ...
                              <a class="resetText" href="#">Reset</a>
                              <hr>
                              ...
                              <hr>
                              <a class="linkListProduct mt-3 mb-3" href="#">Daftar Semua Produk</a>
                        </div>
                        <div class="col">
